...
const Home = () => {
  ...
  return (
    <>
      <GenericMeta
        title="ven.earth"
        description="22-year-old software engineer and student from the United Kingdom."
      />

      <MainLayout margin={false}>
        <h1 className="text-6xl font-bold">ven</h1>
        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-sm mt-2">
          22-year-old <span className="font-semibold">software engineer</span> from the United
          Kingdom.
        </p>
